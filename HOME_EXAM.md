...
<img src="https://render.githubusercontent.com/render/math?math=\frac{<e_1, \sigma> \Downarrow a_1 <e_2, \sigma> \Downarrow a_2 ... <e_n, \sigma> \Downarrow a_n}{<p_1 := e_1, p_2 := e_2...p_n:= e_n, \sigma _2> \Downarrow \sigma _2[p_1 -> a_1, p_2 -> a_2... p_n -> a_n]}">

Here σ2 is a new environment which is initially empty. The arguments however are evaluated in the callers context.
